...
const token = '2141879275:AAHO7MJHZ0KKCjX7fvXjzojhN3e_x-hm4aE';
...
router.get('/sensor/:sensor1/:sensor2/:sensor3', (req, res, next) => {
  try {
      bot.sendMessage(
            ...
            `Sensor Kelmbababan:: ${req.params.sensor1} \n
            Sensor Jarak:: ${req.params.sensor2} \n
            Sensor Suhu:: ${req.params.sensor3}`
     );
      res.json({
        "status": 202,
        "messgae": "Success",
